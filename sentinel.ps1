...
.SYNOPSIS
    ...
    - FIXED: New MAS URL (get.activated.win)
    - FIXED: UI Alignment & Centering
    - NEW: Option [H] Internal Help Manual
    - WEBSITE: https://www.a2k.lat/
#>

# Force TLS 1.2 and Refresh DNS to ensure MAS works
...
} while ($true)#Requires -RunAsAdministrator
